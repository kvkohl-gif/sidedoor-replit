              ...
              <div>
                <div className="relative">
                  <Textarea
                    ...
                    className={`peer w-full resize-none transition-all duration-200 px-4 py-4 rounded-xl border placeholder-transparent focus:placeholder-transparent outline-none focus:ring-4 focus:ring-blue-200/50 ${
                      isInputLocked 
                    ...
                    aria-describedby="jd-help-landing"
                  />
                  
                  {/* Floating label */}
                  <label
                    htmlFor="jobDescriptionLanding"
                ...
                <p id="jd-help-landing" className="text-sm text-slate-500 mt-2">
