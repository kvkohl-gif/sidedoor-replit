...
export function getSession() {
  ...
  // Use memory store temporarily to avoid database connection issues
  ...
  return session({
    ...
    cookie: {
      ...
      sameSite: "none",     // needed for Replit iframe / cross-site
      path: "/",
...
function updateUserSession(
  ...
  user.id = user.claims.sub; // Add direct access to user ID
